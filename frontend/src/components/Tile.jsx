...
//               </button>
//             </a>
//             <Link to='/team/details' className="bg-sky-900 hover:bg-blue-700 text-white px-6 py-1 mt-1 rounded-md">
//               Request Guideship
//             </Link>
...
const Tile = ({ image, name, role, email, info, domains = [], slots }) => {
  ...
  const handleRequestGuideship = () => {
    // Navigate to team/details and pass the mentor's email via state
    navigate("/team/details", { state: { mentorEmail: email } });
  };
      ...
      <div className="bg-white shadow-xl rounded-lg my-10 mx-2 w-full gap-4 flex flex-col justify-between">
        ...
        <div className="flex flex-col justify-between gap-4 pb-4 px-5 py-2 text-md h-full">
          ...
          <div className="flex flex-col items-center mt-auto">
            ...
            <button
              onClick={handleRequestGuideship}
              className="bg-sky-900 hover:bg-blue-700 text-white px-6 py-1 mt-1 rounded-md"
            >
              Request Guideship
            </button>
            <p className="pt-2">{slots} slots remaining</p>
